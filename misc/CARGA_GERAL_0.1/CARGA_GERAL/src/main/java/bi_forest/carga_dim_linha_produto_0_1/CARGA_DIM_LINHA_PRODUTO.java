...
package bi_forest.carga_dim_linha_produto_0_1;
...
/**
 * Job: CARGA_DIM_LINHA_PRODUTO Purpose: <br>
 * Description: CADASTRO LINHA DE PRODUTO <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class CARGA_DIM_LINHA_PRODUTO implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "CARGA_DIM_LINHA_PRODUTO";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				CARGA_DIM_LINHA_PRODUTO.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CARGA_DIM_LINHA_PRODUTO.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_BI_FOREST_CARGA_DIM_LINHA_PRODUTO = new byte[0];
    static byte[] commonByteArray_BI_FOREST_CARGA_DIM_LINHA_PRODUTO = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BI_FOREST_CARGA_DIM_LINHA_PRODUTO.length) {
				if(length < 1024 && commonByteArray_BI_FOREST_CARGA_DIM_LINHA_PRODUTO.length == 0) {
   					commonByteArray_BI_FOREST_CARGA_DIM_LINHA_PRODUTO = new byte[1024];
				} else {
   					commonByteArray_BI_FOREST_CARGA_DIM_LINHA_PRODUTO = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BI_FOREST_CARGA_DIM_LINHA_PRODUTO, 0, length);
			strReturn = new String(commonByteArray_BI_FOREST_CARGA_DIM_LINHA_PRODUTO, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BI_FOREST_CARGA_DIM_LINHA_PRODUTO) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DESC_LINHA = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.DESC_LINHA,dos);
    ...
    public int compareTo(row1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.SK_LINHA_PROD, other.SK_LINHA_PROD);
						if(returnValue != 0) {
							return returnValue;
						}
	...
	class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				int result = DEFAULT_HASHCODE;
							...
							result = prime * result + ((this.DESC_LINHA == null) ? 0 : this.DESC_LINHA.hashCode());
		...
		public boolean equals(Object obj) {
			...
			final AggOperationStruct_tAggregateRow_1 other = (AggOperationStruct_tAggregateRow_1) obj;
							...
							if (this.DESC_LINHA == null) {
								if (other.DESC_LINHA != null) 
									return false;
							} else if (!this.DESC_LINHA.equals(other.DESC_LINHA)) 
								return false;
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:mkBZr8FxDyg/BFWoz29z5jjWHBy9FB2csbV7heEJl2wZZsuE");
		    ...
		    String dbquery_tDBInput_1 = "SELECT dbo.STG_LINHA_PRODUTO.COD_EMPRESA,\n		dbo.STG_LINHA_PRODUTO.COD_LINHA,\n		dbo.STG_LINHA_PRODUTO.DESC_LINHA\nFROM	db"
+"o.STG_LINHA_PRODUTO";
            ...
            row2.COD_EMPRESA = rs_tDBInput_1.getInt(1);
            ...
            row2.COD_LINHA = rs_tDBInput_1.getInt(2);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row2.DESC_LINHA = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.DESC_LINHA = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row2.DESC_LINHA = tmpContent_tDBInput_1;
                }
            } else {
                row2.DESC_LINHA = null;
            }
...
// # Output table : 'SAIDA'
SAIDA_tmp.SK_LINHA_PROD = 0;
SAIDA_tmp.SK_EMPRESA = row3.SK_EMPRESA ;
SAIDA_tmp.COD_LINHA = row2.COD_LINHA ;
SAIDA_tmp.DESC_LINHA = row2.DESC_LINHA ;
SAIDA = SAIDA_tmp;
...
operation_finder_tAggregateRow_1.SK_LINHA_PROD = SAIDA.SK_LINHA_PROD;
			...
			operation_finder_tAggregateRow_1.COD_LINHA = SAIDA.COD_LINHA;
			operation_finder_tAggregateRow_1.DESC_LINHA = SAIDA.DESC_LINHA;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_1.SK_LINHA_PROD = operation_finder_tAggregateRow_1.SK_LINHA_PROD;
				...
				operation_result_tAggregateRow_1.COD_LINHA = operation_finder_tAggregateRow_1.COD_LINHA;
				operation_result_tAggregateRow_1.DESC_LINHA = operation_finder_tAggregateRow_1.DESC_LINHA;
...
public int hashCode() {
if(hashCodeDirty) {
int prime = 31;hashCode = prime * hashCode + COD_LINHA;
...
String dbUser_tDBSCD_1 = null;
	...
	final String decryptedPassword_tDBSCD_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:KbrryIivxFH3zv3mEpqu1WKwbYBOCo9tswXNp4yZbxWO2JOm");
    ...
    if(dbschema_tDBSCD_1 == null || dbschema_tDBSCD_1.trim().length() == 0) {
        tableName_tDBSCD_1 = "DIM_LINHA_PRODUTO";
    } else {
        tableName_tDBSCD_1 = dbschema_tDBSCD_1 + "].[" + "DIM_LINHA_PRODUTO";
    }
    ...
    String tmpValue_tDBSCD_1 = null;    
        String search_tDBSCD_1 = "SELECT [COD_LINHA], [SK_EMPRESA], [DESC_LINHA] FROM [" + tableName_tDBSCD_1 + "]";
        ...
        while(resultSet_tDBSCD_1.next()) {
            ...
            SCDStruct_tDBSCD_1 row_tDBSCD_1 = new SCDStruct_tDBSCD_1();
                    if(resultSet_tDBSCD_1.getObject(1) != null) {
                        sk_tDBSCD_1.COD_LINHA = resultSet_tDBSCD_1.getInt(1);
                    }
                    ...
                    if(resultSet_tDBSCD_1.getObject(3) != null) {
                        row_tDBSCD_1.DESC_LINHA = resultSet_tDBSCD_1.getString(3);
                    }
        ...
        String tmpQuery_tDBSCD_1 = "SELECT MAX([SK_LINHA_PROD]) FROM [" + tableName_tDBSCD_1 + "]";
    ...
    String insertionSQL_tDBSCD_1 = "INSERT INTO [" + tableName_tDBSCD_1 + "]([SK_LINHA_PROD], [COD_LINHA], [SK_EMPRESA], [DESC_LINHA]) VALUES(?, ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tDBSCD_1 = conn_tDBSCD_1.prepareStatement(insertionSQL_tDBSCD_1);
        String updateSQLForType1_tDBSCD_1 = "UPDATE [" + tableName_tDBSCD_1 + "] SET [DESC_LINHA] = ? WHERE [COD_LINHA] = ? AND [SK_EMPRESA] = ?";
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row1.SK_LINHA_PROD = aggregated_row_tAggregateRow_1.SK_LINHA_PROD;
            				    
            				    row1.SK_EMPRESA = aggregated_row_tAggregateRow_1.SK_EMPRESA;
            				    
            				    row1.COD_LINHA = aggregated_row_tAggregateRow_1.COD_LINHA;
            				    
            				    row1.DESC_LINHA = aggregated_row_tAggregateRow_1.DESC_LINHA;
 ...
 */
	...
	try {
        lookUpKey_tDBSCD_1 = new SCDSK_tDBSCD_1();
            lookUpKey_tDBSCD_1.COD_LINHA = row1.COD_LINHA;
    ...
    if(lookUpValue_tDBSCD_1 == null) {
            lookUpValue_tDBSCD_1 = new SCDStruct_tDBSCD_1();
                    ...
                    insertionStatement_tDBSCD_1.setInt(2, row1.COD_LINHA);

                    insertionStatement_tDBSCD_1.setInt(3, row1.SK_EMPRESA);

                    if(row1.DESC_LINHA == null) {
insertionStatement_tDBSCD_1.setNull(4, java.sql.Types.VARCHAR);
} else {
insertionStatement_tDBSCD_1.setString(4, row1.DESC_LINHA);
}

        nb_line_inserted_tDBSCD_1 += insertionStatement_tDBSCD_1.executeUpdate();
    } else {
            if((lookUpValue_tDBSCD_1.DESC_LINHA == null && row1.DESC_LINHA!= null) || (lookUpValue_tDBSCD_1.DESC_LINHA != null && !lookUpValue_tDBSCD_1.DESC_LINHA.equals(row1.DESC_LINHA))) {
                    if(row1.DESC_LINHA == null) {
updateForType1_tDBSCD_1.setNull(1, java.sql.Types.VARCHAR);
} else {
updateForType1_tDBSCD_1.setString(1, row1.DESC_LINHA);
}

                    updateForType1_tDBSCD_1.setInt(2, row1.COD_LINHA);

                    updateForType1_tDBSCD_1.setInt(3, row1.SK_EMPRESA);
                ...
                lookUpValue_tDBSCD_1.DESC_LINHA = row1.DESC_LINHA;
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:oaCP3wTnIWzmtAQPNGH6U8G0BdhFJz8FTw8o658ErZCTjVrn");
		    ...
		    String dbquery_tDBInput_2 = "SELECT dbo.DIM_EMPRESA.SK_EMPRESA,\n		dbo.DIM_EMPRESA.COD_EMPRESA,\n		dbo.DIM_EMPRESA.NOME_EMPRESA,\n		dbo.DIM_EMPRESA.FAN"
+"TASIA,\n		dbo.DIM_EMPRESA.CNPJ,\n		dbo.DIM_EMPRESA.ENDERECO,\n		dbo.DIM_EMPRESA.COD_CIDADE\nFROM	dbo.DIM_EMPRESA";
            ...
            row3.SK_EMPRESA = rs_tDBInput_2.getInt(1);
            ...
            row3.COD_EMPRESA = rs_tDBInput_2.getInt(2);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.NOME_EMPRESA = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row3.NOME_EMPRESA = tmpContent_tDBInput_2;
                }
            } else {
                row3.NOME_EMPRESA = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.FANTASIA = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row3.FANTASIA = tmpContent_tDBInput_2;
                }
            } else {
                row3.FANTASIA = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(5).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.CNPJ = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row3.CNPJ = tmpContent_tDBInput_2;
                }
            } else {
                row3.CNPJ = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(6).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.ENDERECO = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row3.ENDERECO = tmpContent_tDBInput_2;
                }
            } else {
                row3.ENDERECO = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(7).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.COD_CIDADE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row3.COD_CIDADE = tmpContent_tDBInput_2;
                }
            } else {
                row3.COD_CIDADE = null;
            }
 ...
 */
    ...
    public static void main(String[] args){
        final CARGA_DIM_LINHA_PRODUTO CARGA_DIM_LINHA_PRODUTOClass = new CARGA_DIM_LINHA_PRODUTO();

        int exitCode = CARGA_DIM_LINHA_PRODUTOClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CARGA_DIM_LINHA_PRODUTO.class.getClassLoader().getResourceAsStream("bi_forest/carga_dim_linha_produto_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CARGA_DIM_LINHA_PRODUTO.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CARGA_DIM_LINHA_PRODUTO");
        }
...
/************************************************************************************************
 *     100512 characters generated by Talend Open Studio for Data Integration 
