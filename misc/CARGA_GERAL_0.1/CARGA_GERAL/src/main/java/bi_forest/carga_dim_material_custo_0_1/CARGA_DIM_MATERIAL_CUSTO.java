...
package bi_forest.carga_dim_material_custo_0_1;
...
/**
 * Job: CARGA_DIM_MATERIAL_CUSTO Purpose: <br>
 * Description: CADASTRO DE CUSTO DO MATERIAL <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class CARGA_DIM_MATERIAL_CUSTO implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "CARGA_DIM_MATERIAL_CUSTO";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				CARGA_DIM_MATERIAL_CUSTO.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CARGA_DIM_MATERIAL_CUSTO.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_BI_FOREST_CARGA_DIM_MATERIAL_CUSTO = new byte[0];
    static byte[] commonByteArray_BI_FOREST_CARGA_DIM_MATERIAL_CUSTO = new byte[0];
    ...
    public String loopKey;
			    ...
			    public Integer CUSTO_MEDIO;

				public Integer getCUSTO_MEDIO () {
					return this.CUSTO_MEDIO;
				}
				
			    public java.util.Date DATA_INI;

				public java.util.Date getDATA_INI () {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.DATA_INI == null) ? 0 : this.DATA_INI.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row1Struct other = (row1Struct) obj;
						...
						if (this.DATA_INI == null) {
							if (other.DATA_INI != null)
								return false;
						
						} else if (!this.DATA_INI.equals(other.DATA_INI))
	...
	public void copyDataTo(row1Struct other) {
		...
		other.SK_EMPRESA = this.SK_EMPRESA;
	            ...
	            other.CUSTO_MEDIO = this.CUSTO_MEDIO;
	            other.DATA_INI = this.DATA_INI;
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BI_FOREST_CARGA_DIM_MATERIAL_CUSTO) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.SK_MAT = dis.readInt();
						...
						this.CUSTO_MEDIO = readInteger(dis);
					
					this.DATA_INI = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.CUSTO_MEDIO,dos);
					
					// java.util.Date
				
						writeDate(this.DATA_INI,dos);
    ...
    public String toString() {
		...
		sb.append(",CUSTO_MEDIO="+String.valueOf(CUSTO_MEDIO));
		sb.append(",DATA_INI="+String.valueOf(DATA_INI));
    ...
    public int compareTo(row1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.DATA_INI, other.DATA_INI);
						if(returnValue != 0) {
							return returnValue;
						}
	...
	class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				int result = DEFAULT_HASHCODE;
							...
							result = prime * result + ((this.CUSTO_MEDIO == null) ? 0 : this.CUSTO_MEDIO.hashCode());
							
							result = prime * result + ((this.DATA_INI == null) ? 0 : this.DATA_INI.hashCode());
							
							result = prime * result + ((this.DATA_FIM == null) ? 0 : this.DATA_FIM.hashCode());
		...
		public boolean equals(Object obj) {
			...
			final AggOperationStruct_tAggregateRow_1 other = (AggOperationStruct_tAggregateRow_1) obj;
							...
							if (this.CUSTO_MEDIO == null) {
								if (other.CUSTO_MEDIO != null) 
									return false;
							} else if (!this.CUSTO_MEDIO.equals(other.CUSTO_MEDIO)) 
								return false;
							...
							if (this.DATA_FIM == null) {
								if (other.DATA_FIM != null) 
									return false;
							} else if (!this.DATA_FIM.equals(other.DATA_FIM)) 
								return false;
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:uccSzhNkt1owgne0HV5yY7Hfj3gMUxSkpHg2tBfVBxOWSk7t");
		    ...
		    String dbquery_tDBInput_2 = "SELECT dbo.STG_MATERIAL_CUSTO.COD_EMPRESA,\n		dbo.STG_MATERIAL_CUSTO.COD_MAT,\n		dbo.STG_MATERIAL_CUSTO.CUSTO_MEDIO,\n		db"
+"o.STG_MATERIAL_CUSTO.DATA_INI,\n		dbo.STG_MATERIAL_CUSTO.DATA_FIM\nFROM	dbo.STG_MATERIAL_CUSTO";
            ...
            row2.COD_MAT = rs_tDBInput_2.getInt(2);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row2.CUSTO_MEDIO = null;
							} else {
		                          
            row2.CUSTO_MEDIO = rs_tDBInput_2.getInt(3);
            if(rs_tDBInput_2.wasNull()){
                    row2.CUSTO_MEDIO = null;
            }
		                    }
			...
			row2.DATA_INI = mssqlGTU_tDBInput_2.getDate(rsmd_tDBInput_2, rs_tDBInput_2, 4);
			...
			row2.DATA_FIM = mssqlGTU_tDBInput_2.getDate(rsmd_tDBInput_2, rs_tDBInput_2, 5);
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row4__SK_EMPRESA = row3.SK_EMPRESA ;
	                        		    	if(exprKeyValue_row4__SK_EMPRESA == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row4HashKey.SK_EMPRESA = (int)(Integer) exprKeyValue_row4__SK_EMPRESA;
                        		    		}
                        		    		
	                        		    	Object exprKeyValue_row4__COD_EMPRESA = row3.COD_EMPRESA ;
	                        		    	if(exprKeyValue_row4__COD_EMPRESA == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row4HashKey.COD_EMPRESA = (int)(Integer) exprKeyValue_row4__COD_EMPRESA;
                        		    		}
                        		    		
	                        		    	Object exprKeyValue_row4__COD_MAT = row2.COD_MAT ;
	                        		    	if(exprKeyValue_row4__COD_MAT == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row4HashKey.COD_MAT = (int)(Integer) exprKeyValue_row4__COD_MAT;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row4.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.SK_EMPRESA = '" + row4HashKey.SK_EMPRESA + "', row4.COD_EMPRESA = '" + row4HashKey.COD_EMPRESA + "', row4.COD_MAT = '" + row4HashKey.COD_MAT + "'");
								} // G 071
...
SAIDA_tmp.SK_MAT = row4.SK_MAT ;
SAIDA_tmp.CUSTO_MEDIO = row2.CUSTO_MEDIO ;
SAIDA_tmp.DATA_INI = row2.DATA_INI ;
SAIDA_tmp.DATA_FIM = row2.DATA_FIM ;
SAIDA = SAIDA_tmp;
...
operation_finder_tAggregateRow_1.SK_EMPRESA = SAIDA.SK_EMPRESA;
			...
			operation_finder_tAggregateRow_1.CUSTO_MEDIO = SAIDA.CUSTO_MEDIO;
			operation_finder_tAggregateRow_1.DATA_INI = SAIDA.DATA_INI;
			operation_finder_tAggregateRow_1.DATA_FIM = SAIDA.DATA_FIM;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_1.SK_EMPRESA = operation_finder_tAggregateRow_1.SK_EMPRESA;
				...
				operation_result_tAggregateRow_1.CUSTO_MEDIO = operation_finder_tAggregateRow_1.CUSTO_MEDIO;
				operation_result_tAggregateRow_1.DATA_INI = operation_finder_tAggregateRow_1.DATA_INI;
				operation_result_tAggregateRow_1.DATA_FIM = operation_finder_tAggregateRow_1.DATA_FIM;
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:kBvSW0M3QUNBk2ELIZfOZlHli/i7lwe2wd6jQb/zDTlAIKxM");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "DIM_MATERIAL_CUSTO";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "DIM_MATERIAL_CUSTO";
}
	int count_tDBOutput_1=0;
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1 + "]([SK_EMPRESA] INT  not null ,[SK_MAT] INT  not null ,[CUSTO_MEDIO] INT ,[DATA_INI] DATE  not null ,[DATA_FIM] DATE ,primary key([SK_EMPRESA],[SK_MAT],[DATA_INI]))");
                                    }
                                }
        java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_1 + "] WHERE [SK_EMPRESA] = ? AND [SK_MAT] = ? AND [DATA_INI] = ?");
        resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([SK_EMPRESA],[SK_MAT],[CUSTO_MEDIO],[DATA_INI],[DATA_FIM]) VALUES (?,?,?,?,?)";
        java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
        resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
        String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1 + "] SET [CUSTO_MEDIO] = ?,[DATA_FIM] = ? WHERE [SK_EMPRESA] = ? AND [SK_MAT] = ? AND [DATA_INI] = ?";
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row1.CUSTO_MEDIO = aggregated_row_tAggregateRow_1.CUSTO_MEDIO;
            				    
            				    row1.DATA_INI = aggregated_row_tAggregateRow_1.DATA_INI;
            				    
            				    row1.DATA_FIM = aggregated_row_tAggregateRow_1.DATA_FIM;
 ...
 */
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    ...
                    pstmt_tDBOutput_1.setInt(2, row1.SK_MAT);



                    if(row1.DATA_INI != null) {
pstmt_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(row1.DATA_INI.getTime()));
} else {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.DATE);
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        if(row1.CUSTO_MEDIO == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(1, row1.CUSTO_MEDIO);
}

                        if(row1.DATA_FIM != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(2, new java.sql.Timestamp(row1.DATA_FIM.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.DATE);
                        ...
                        pstmtUpdate_tDBOutput_1.setInt(3 + count_tDBOutput_1, row1.SK_EMPRESA);


	                    

                        pstmtUpdate_tDBOutput_1.setInt(4 + count_tDBOutput_1, row1.SK_MAT);


	                    

                        if(row1.DATA_INI != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(5 + count_tDBOutput_1, new java.sql.Timestamp(row1.DATA_INI.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.DATE);
}
            ...
            try {
                    ...
                    whetherReject_tDBOutput_1 = true;
                        ...
                        pstmtInsert_tDBOutput_1.setInt(2, row1.SK_MAT);

                        if(row1.CUSTO_MEDIO == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(3, row1.CUSTO_MEDIO);
}

                        if(row1.DATA_INI != null) {
pstmtInsert_tDBOutput_1.setTimestamp(4, new java.sql.Timestamp(row1.DATA_INI.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.DATE);
}

                        if(row1.DATA_FIM != null) {
pstmtInsert_tDBOutput_1.setTimestamp(5, new java.sql.Timestamp(row1.DATA_FIM.getTime()));
} else {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row2,row3,row4) outputs:(SAIDA)
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:sNyjFnRvp2jW3paj6Y2L7XG7U2xQ0iLMu3KoMz60Soa5hEhS");
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:/3E1TuaRMVg5fIslJZB0kZc9YdP6lkjmtiEUhM8WzsdOHg8w");
...
+".DESCRICAO,\n		dbo.DIM_MATERIAL.PRECO_UNIT\nFROM	dbo.DIM_MATERIAL";
            ...
            row4.SK_MAT = rs_tDBInput_3.getInt(1);
            ...
            row4.SK_EMPRESA = rs_tDBInput_3.getInt(2);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row4.SK_TIP_MAT = rs_tDBInput_3.getInt(3);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row4.SK_LINHA_PROD = 0;
							} else {
		                          
            row4.SK_LINHA_PROD = rs_tDBInput_3.getInt(4);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row4.SK_SUB_CATEG = rs_tDBInput_3.getInt(5);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row4.COD_EMPRESA = rs_tDBInput_3.getInt(6);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row4.COD_MAT = rs_tDBInput_3.getInt(7);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(8).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.DESCRICAO = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row4.DESCRICAO = tmpContent_tDBInput_3;
                }
            } else {
                row4.DESCRICAO = null;
            }
							...
							if(colQtyInRs_tDBInput_3 < 9) {
								row4.PRECO_UNIT = null;
							} else {
		                          
            row4.PRECO_UNIT = rs_tDBInput_3.getBigDecimal(9);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
				...
				row4_HashRow.SK_MAT = row4.SK_MAT;
				
				row4_HashRow.SK_EMPRESA = row4.SK_EMPRESA;
				
				row4_HashRow.SK_TIP_MAT = row4.SK_TIP_MAT;
				
				row4_HashRow.SK_LINHA_PROD = row4.SK_LINHA_PROD;
				
				row4_HashRow.SK_SUB_CATEG = row4.SK_SUB_CATEG;
				
				row4_HashRow.COD_EMPRESA = row4.COD_EMPRESA;
				
				row4_HashRow.COD_MAT = row4.COD_MAT;
				
				row4_HashRow.DESCRICAO = row4.DESCRICAO;
				
				row4_HashRow.PRECO_UNIT = row4.PRECO_UNIT;
 ...
 */
    ...
    public static void main(String[] args){
        final CARGA_DIM_MATERIAL_CUSTO CARGA_DIM_MATERIAL_CUSTOClass = new CARGA_DIM_MATERIAL_CUSTO();

        int exitCode = CARGA_DIM_MATERIAL_CUSTOClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CARGA_DIM_MATERIAL_CUSTO.class.getClassLoader().getResourceAsStream("bi_forest/carga_dim_material_custo_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CARGA_DIM_MATERIAL_CUSTO.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CARGA_DIM_MATERIAL_CUSTO");
        }
...
/************************************************************************************************
 *     138299 characters generated by Talend Open Studio for Data Integration 
