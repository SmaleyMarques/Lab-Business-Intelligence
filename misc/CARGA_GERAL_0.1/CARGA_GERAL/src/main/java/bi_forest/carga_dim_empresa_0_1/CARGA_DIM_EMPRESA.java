...
package bi_forest.carga_dim_empresa_0_1;
...
/**
 * Job: CARGA_DIM_EMPRESA Purpose: <br>
 * Description: CADASTRO DA EMPRESA <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class CARGA_DIM_EMPRESA implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "CARGA_DIM_EMPRESA";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				CARGA_DIM_EMPRESA.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CARGA_DIM_EMPRESA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class SAIDAStruct implements routines.system.IPersistableRow<SAIDAStruct> {
    final static byte[] commonByteArrayLock_BI_FOREST_CARGA_DIM_EMPRESA = new byte[0];
    static byte[] commonByteArray_BI_FOREST_CARGA_DIM_EMPRESA = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BI_FOREST_CARGA_DIM_EMPRESA.length) {
				if(length < 1024 && commonByteArray_BI_FOREST_CARGA_DIM_EMPRESA.length == 0) {
   					commonByteArray_BI_FOREST_CARGA_DIM_EMPRESA = new byte[1024];
				} else {
   					commonByteArray_BI_FOREST_CARGA_DIM_EMPRESA = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BI_FOREST_CARGA_DIM_EMPRESA, 0, length);
			strReturn = new String(commonByteArray_BI_FOREST_CARGA_DIM_EMPRESA, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BI_FOREST_CARGA_DIM_EMPRESA) {
...
String dbUser_tDBSCD_1 = null;
	...
	final String decryptedPassword_tDBSCD_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:D0+sVOrg+h5EiVVJGFKclVmGhswEybzZd+Bhzz50QCYh4cA/");
    ...
    if(dbschema_tDBSCD_1 == null || dbschema_tDBSCD_1.trim().length() == 0) {
        tableName_tDBSCD_1 = "DIM_EMPRESA";
    } else {
        tableName_tDBSCD_1 = dbschema_tDBSCD_1 + "].[" + "DIM_EMPRESA";
    }
    ...
    String tmpValue_tDBSCD_1 = null;    
        String search_tDBSCD_1 = "SELECT [COD_EMPRESA], [COD_CIDADE], [ENDERECO], [FANTASIA], [NOME_EMPRESA], [CNPJ] FROM [" + tableName_tDBSCD_1 + "]";
        ...
        while(resultSet_tDBSCD_1.next()) {
            ...
            SCDStruct_tDBSCD_1 row_tDBSCD_1 = new SCDStruct_tDBSCD_1();
                    ...
                    if(resultSet_tDBSCD_1.getObject(2) != null) {
                        row_tDBSCD_1.COD_CIDADE = resultSet_tDBSCD_1.getString(2);
                    }
                    if(resultSet_tDBSCD_1.getObject(3) != null) {
                        row_tDBSCD_1.ENDERECO = resultSet_tDBSCD_1.getString(3);
                    }
                    if(resultSet_tDBSCD_1.getObject(4) != null) {
                        row_tDBSCD_1.FANTASIA = resultSet_tDBSCD_1.getString(4);
                    }
                    if(resultSet_tDBSCD_1.getObject(5) != null) {
                        row_tDBSCD_1.NOME_EMPRESA = resultSet_tDBSCD_1.getString(5);
                    }
                    if(resultSet_tDBSCD_1.getObject(6) != null) {
                        row_tDBSCD_1.CNPJ = resultSet_tDBSCD_1.getString(6);
                    }
        ...
        String tmpQuery_tDBSCD_1 = "SELECT MAX([SK_EMPRESA]) FROM [" + tableName_tDBSCD_1 + "]";
    ...
    String insertionSQL_tDBSCD_1 = "INSERT INTO [" + tableName_tDBSCD_1 + "]([SK_EMPRESA], [COD_EMPRESA], [COD_CIDADE], [ENDERECO], [FANTASIA], [NOME_EMPRESA], [CNPJ]) VALUES(?, ?, ?, ?, ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tDBSCD_1 = conn_tDBSCD_1.prepareStatement(insertionSQL_tDBSCD_1);
        String updateSQLForType1_tDBSCD_1 = "UPDATE [" + tableName_tDBSCD_1 + "] SET [COD_CIDADE] = ?, [ENDERECO] = ?, [FANTASIA] = ?, [NOME_EMPRESA] = ?, [CNPJ] = ? WHERE [COD_EMPRESA] = ?";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:dP55YPC7KmyGHd8EqVSpR6EYp4Mgysk2HZTqGj1P6iYT5HRC");
		    ...
		    String dbquery_tDBInput_1 = "SELECT dbo.STG_EMPRESA.COD_EMPRESA,\n		dbo.STG_EMPRESA.NOME_EMPRESA,\n		dbo.STG_EMPRESA.FANTASIA,\n		dbo.STG_EMPRESA.CNPJ,"
+"\n		dbo.STG_EMPRESA.ENDERECO,\n		dbo.STG_EMPRESA.COD_CIDADE\nFROM	dbo.STG_EMPRESA";
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.NOME_EMPRESA = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.NOME_EMPRESA = tmpContent_tDBInput_1;
                }
            } else {
                row1.NOME_EMPRESA = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
                	...
                	row1.CNPJ = tmpContent_tDBInput_1;
                }
            } else {
                row1.CNPJ = null;
            }
...
// # Output table : 'SAIDA'
SAIDA_tmp.SK_EMPRESA = 0;
SAIDA_tmp.COD_EMPRESA = row1.COD_EMPRESA ;
SAIDA_tmp.NOME_EMPRESA = row1.NOME_EMPRESA ;
SAIDA_tmp.FANTASIA = row1.FANTASIA ;
SAIDA_tmp.CNPJ = row1.CNPJ ;
...
insertionStatement_tDBSCD_1.setString(3, SAIDA.COD_CIDADE);
}

                    if(SAIDA.ENDERECO == null) {
insertionStatement_tDBSCD_1.setNull(4, java.sql.Types.VARCHAR);
} else {
insertionStatement_tDBSCD_1.setString(4, SAIDA.ENDERECO);
}

                    if(SAIDA.FANTASIA == null) {
insertionStatement_tDBSCD_1.setNull(5, java.sql.Types.VARCHAR);
} else {
insertionStatement_tDBSCD_1.setString(5, SAIDA.FANTASIA);
}

                    if(SAIDA.NOME_EMPRESA == null) {
insertionStatement_tDBSCD_1.setNull(6, java.sql.Types.VARCHAR);
} else {
insertionStatement_tDBSCD_1.setString(6, SAIDA.NOME_EMPRESA);
}

                    if(SAIDA.CNPJ == null) {
insertionStatement_tDBSCD_1.setNull(7, java.sql.Types.VARCHAR);
} else {
insertionStatement_tDBSCD_1.setString(7, SAIDA.CNPJ);
}

        nb_line_inserted_tDBSCD_1 += insertionStatement_tDBSCD_1.executeUpdate();
    } else {
            if((lookUpValue_tDBSCD_1.COD_CIDADE == null && SAIDA.COD_CIDADE!= null) || (lookUpValue_tDBSCD_1.COD_CIDADE != null && !lookUpValue_tDBSCD_1.COD_CIDADE.equals(SAIDA.COD_CIDADE)) || (lookUpValue_tDBSCD_1.ENDERECO == null && SAIDA.ENDERECO!= null) || (lookUpValue_tDBSCD_1.ENDERECO != null && !lookUpValue_tDBSCD_1.ENDERECO.equals(SAIDA.ENDERECO)) || (lookUpValue_tDBSCD_1.FANTASIA == null && SAIDA.FANTASIA!= null) || (lookUpValue_tDBSCD_1.FANTASIA != null && !lookUpValue_tDBSCD_1.FANTASIA.equals(SAIDA.FANTASIA)) || (lookUpValue_tDBSCD_1.NOME_EMPRESA == null && SAIDA.NOME_EMPRESA!= null) || (lookUpValue_tDBSCD_1.NOME_EMPRESA != null && !lookUpValue_tDBSCD_1.NOME_EMPRESA.equals(SAIDA.NOME_EMPRESA)) || (lookUpValue_tDBSCD_1.CNPJ == null && SAIDA.CNPJ!= null) || (lookUpValue_tDBSCD_1.CNPJ != null && !lookUpValue_tDBSCD_1.CNPJ.equals(SAIDA.CNPJ))) {
                    if(SAIDA.COD_CIDADE == null) {
updateForType1_tDBSCD_1.setNull(1, java.sql.Types.VARCHAR);
} else {
updateForType1_tDBSCD_1.setString(1, SAIDA.COD_CIDADE);
}

                    if(SAIDA.ENDERECO == null) {
updateForType1_tDBSCD_1.setNull(2, java.sql.Types.VARCHAR);
} else {
updateForType1_tDBSCD_1.setString(2, SAIDA.ENDERECO);
}

                    if(SAIDA.FANTASIA == null) {
updateForType1_tDBSCD_1.setNull(3, java.sql.Types.VARCHAR);
} else {
updateForType1_tDBSCD_1.setString(3, SAIDA.FANTASIA);
}

                    if(SAIDA.NOME_EMPRESA == null) {
updateForType1_tDBSCD_1.setNull(4, java.sql.Types.VARCHAR);
} else {
updateForType1_tDBSCD_1.setString(4, SAIDA.NOME_EMPRESA);
}

                    if(SAIDA.CNPJ == null) {
updateForType1_tDBSCD_1.setNull(5, java.sql.Types.VARCHAR);
} else {
updateForType1_tDBSCD_1.setString(5, SAIDA.CNPJ);
}

                    updateForType1_tDBSCD_1.setInt(6, SAIDA.COD_EMPRESA);
                ...
                lookUpValue_tDBSCD_1.NOME_EMPRESA = SAIDA.NOME_EMPRESA;
                lookUpValue_tDBSCD_1.CNPJ = SAIDA.CNPJ;
 ...
 */
    ...
    public static void main(String[] args){
        final CARGA_DIM_EMPRESA CARGA_DIM_EMPRESAClass = new CARGA_DIM_EMPRESA();

        int exitCode = CARGA_DIM_EMPRESAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CARGA_DIM_EMPRESA.class.getClassLoader().getResourceAsStream("bi_forest/carga_dim_empresa_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CARGA_DIM_EMPRESA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CARGA_DIM_EMPRESA");
        }
...
/************************************************************************************************
 *     57809 characters generated by Talend Open Studio for Data Integration 
