...
package bi_forest.carga_dim_vendedor_0_1;
 ...
 * Description: CADASTRO DE VENDEDOR <br>
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_BI_FOREST_CARGA_DIM_VENDEDOR = new byte[0];
    static byte[] commonByteArray_BI_FOREST_CARGA_DIM_VENDEDOR = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BI_FOREST_CARGA_DIM_VENDEDOR.length) {
				if(length < 1024 && commonByteArray_BI_FOREST_CARGA_DIM_VENDEDOR.length == 0) {
   					commonByteArray_BI_FOREST_CARGA_DIM_VENDEDOR = new byte[1024];
				} else {
   					commonByteArray_BI_FOREST_CARGA_DIM_VENDEDOR = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BI_FOREST_CARGA_DIM_VENDEDOR, 0, length);
			strReturn = new String(commonByteArray_BI_FOREST_CARGA_DIM_VENDEDOR, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BI_FOREST_CARGA_DIM_VENDEDOR) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:443j9i46VmQAWEpwBaVoyp1HcMq0LgZNY5r4iEgrWxxj4NWG");
		    ...
		    String dbquery_tDBInput_1 = "SELECT dbo.STG_VENDEDORES.COD_EMPRESA,\n		dbo.STG_VENDEDORES.MATRICULA\nFROM	dbo.STG_VENDEDORES";
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row2__COD_EMPRESA = row1.COD_EMPRESA ;
	                        		    	if(exprKeyValue_row2__COD_EMPRESA == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row2HashKey.COD_EMPRESA = (int)(Integer) exprKeyValue_row2__COD_EMPRESA;
                        		    		}
                        		    		
	                        		    	Object exprKeyValue_row2__MATRICULA = row1.MATRICULA ;
	                        		    	if(exprKeyValue_row2__MATRICULA == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row2HashKey.MATRICULA = (int)(Integer) exprKeyValue_row2__MATRICULA;
                        		    		}
...
operation_finder_tAggregateRow_1.SK_VENDEDOR = SAIDA.SK_VENDEDOR;
			...
			operation_finder_tAggregateRow_1.MATRICULA = SAIDA.MATRICULA;
			operation_finder_tAggregateRow_1.NOME = SAIDA.NOME;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_1.SK_VENDEDOR = operation_finder_tAggregateRow_1.SK_VENDEDOR;
				...
				operation_result_tAggregateRow_1.MATRICULA = operation_finder_tAggregateRow_1.MATRICULA;
				operation_result_tAggregateRow_1.NOME = operation_finder_tAggregateRow_1.NOME;
...
String dbUser_tDBSCD_1 = null;
	...
	final String decryptedPassword_tDBSCD_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:H04u92sPKotURHpH2MzvS5K0/pM1Z6qBpYLG1uRan4O+TCIH");
    ...
    String tmpValue_tDBSCD_1 = null;    
        String search_tDBSCD_1 = "SELECT [COD_EMPRESA], [MATRICULA], [NOME] FROM [" + tableName_tDBSCD_1 + "]";
        ...
        while(resultSet_tDBSCD_1.next()) {
            ...
            SCDStruct_tDBSCD_1 row_tDBSCD_1 = new SCDStruct_tDBSCD_1();
                    ...
                    if(resultSet_tDBSCD_1.getObject(3) != null) {
                        row_tDBSCD_1.NOME = resultSet_tDBSCD_1.getString(3);
                    }
    ...
    String insertionSQL_tDBSCD_1 = "INSERT INTO [" + tableName_tDBSCD_1 + "]([SK_VENDEDOR], [COD_EMPRESA], [MATRICULA], [NOME]) VALUES(?, ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tDBSCD_1 = conn_tDBSCD_1.prepareStatement(insertionSQL_tDBSCD_1);
        String updateSQLForType1_tDBSCD_1 = "UPDATE [" + tableName_tDBSCD_1 + "] SET [NOME] = ? WHERE [COD_EMPRESA] = ? AND [MATRICULA] = ?";
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row3.SK_VENDEDOR = aggregated_row_tAggregateRow_1.SK_VENDEDOR;
            				    
            				    row3.COD_EMPRESA = aggregated_row_tAggregateRow_1.COD_EMPRESA;
            				    
            				    row3.MATRICULA = aggregated_row_tAggregateRow_1.MATRICULA;
            				    
            				    row3.NOME = aggregated_row_tAggregateRow_1.NOME;
 ...
 */
	...
	try {
        lookUpKey_tDBSCD_1 = new SCDSK_tDBSCD_1();
            lookUpKey_tDBSCD_1.COD_EMPRESA = row3.COD_EMPRESA;
            lookUpKey_tDBSCD_1.MATRICULA = row3.MATRICULA;
    ...
    if(lookUpValue_tDBSCD_1 == null) {
            lookUpValue_tDBSCD_1 = new SCDStruct_tDBSCD_1();
                    ...
                    insertionStatement_tDBSCD_1.setInt(2, row3.COD_EMPRESA);

                    insertionStatement_tDBSCD_1.setInt(3, row3.MATRICULA);

                    if(row3.NOME == null) {
insertionStatement_tDBSCD_1.setNull(4, java.sql.Types.VARCHAR);
} else {
insertionStatement_tDBSCD_1.setString(4, row3.NOME);
}

        nb_line_inserted_tDBSCD_1 += insertionStatement_tDBSCD_1.executeUpdate();
    } else {
            if((lookUpValue_tDBSCD_1.NOME == null && row3.NOME!= null) || (lookUpValue_tDBSCD_1.NOME != null && !lookUpValue_tDBSCD_1.NOME.equals(row3.NOME))) {
                    if(row3.NOME == null) {
updateForType1_tDBSCD_1.setNull(1, java.sql.Types.VARCHAR);
} else {
updateForType1_tDBSCD_1.setString(1, row3.NOME);
}

                    updateForType1_tDBSCD_1.setInt(2, row3.COD_EMPRESA);

                    updateForType1_tDBSCD_1.setInt(3, row3.MATRICULA);
                ...
                lookUpValue_tDBSCD_1.NOME = row3.NOME;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2) outputs:(SAIDA)
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:j4BdD52Zjc4zrPRIpCLxJ8yU4IsMrhEy55g9KAqn9MKEEEyg");
		    ...
		    String dbquery_tDBInput_2 = "SELECT dbo.DIM_FUNCIONARIO.SK_FUNC,\n		dbo.DIM_FUNCIONARIO.COD_EMPRESA,\n		dbo.DIM_FUNCIONARIO.MATRICULA,\n		dbo.DIM_FUNCI"
+"ONARIO.NOME,\n		dbo.DIM_FUNCIONARIO.RG,\n		dbo.DIM_FUNCIONARIO.CPF,\n		dbo.DIM_FUNCIONARIO.ENDERECO,\n		dbo.DIM_FUNCIONARIO."
+"NUMERO,\n		dbo.DIM_FUNCIONARIO.BAIRRO,\n		dbo.DIM_FUNCIONARIO.COD_CIDADE,\n		dbo.DIM_FUNCIONARIO.COD_CARGO\nFROM	dbo.DIM_FUN"
+"CIONARIO";
            ...
            row2.SK_FUNC = rs_tDBInput_2.getInt(1);
            ...
            row2.COD_EMPRESA = rs_tDBInput_2.getInt(2);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row2.MATRICULA = rs_tDBInput_2.getInt(3);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.NOME = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row2.NOME = tmpContent_tDBInput_2;
                }
            } else {
                row2.NOME = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(5).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.RG = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row2.RG = tmpContent_tDBInput_2;
                }
            } else {
                row2.RG = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(6).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.CPF = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row2.CPF = tmpContent_tDBInput_2;
                }
            } else {
                row2.CPF = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(7).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.ENDERECO = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row2.ENDERECO = tmpContent_tDBInput_2;
                }
            } else {
                row2.ENDERECO = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(8).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.NUMERO = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row2.NUMERO = tmpContent_tDBInput_2;
                }
            } else {
                row2.NUMERO = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(9).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.BAIRRO = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row2.BAIRRO = tmpContent_tDBInput_2;
                }
            } else {
                row2.BAIRRO = null;
            }
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(10).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.COD_CIDADE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row2.COD_CIDADE = tmpContent_tDBInput_2;
                }
            } else {
                row2.COD_CIDADE = null;
            }
            ...
            row2.COD_CARGO = rs_tDBInput_2.getInt(11);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.SK_FUNC = row2.SK_FUNC;
				
				row2_HashRow.COD_EMPRESA = row2.COD_EMPRESA;
				
				row2_HashRow.MATRICULA = row2.MATRICULA;
				
				row2_HashRow.NOME = row2.NOME;
				
				row2_HashRow.RG = row2.RG;
				
				row2_HashRow.CPF = row2.CPF;
				
				row2_HashRow.ENDERECO = row2.ENDERECO;
				
				row2_HashRow.NUMERO = row2.NUMERO;
				
				row2_HashRow.BAIRRO = row2.BAIRRO;
				
				row2_HashRow.COD_CIDADE = row2.COD_CIDADE;
				
				row2_HashRow.COD_CARGO = row2.COD_CARGO;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CARGA_DIM_VENDEDOR.class.getClassLoader().getResourceAsStream("bi_forest/carga_dim_vendedor_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     98769 characters generated by Talend Open Studio for Data Integration 
