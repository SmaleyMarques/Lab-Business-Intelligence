...
package bi_forest.carga_geral_0_1;
 ...
 * Description: TODOS OS JOBS DO ETL <br>
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CARGA_GERAL.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		bi_forest.limpeza_stg_0_1.LIMPEZA_STG childJob_tRunJob_1 = new bi_forest.limpeza_stg_0_1.LIMPEZA_STG();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		bi_forest.geral_stg_0_1.GERAL_STG childJob_tRunJob_2 = new bi_forest.geral_stg_0_1.GERAL_STG();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		bi_forest.geral_dim_0_1.GERAL_DIM childJob_tRunJob_3 = new bi_forest.geral_dim_0_1.GERAL_DIM();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		bi_forest.geral_fato_0_1.GERAL_FATO childJob_tRunJob_4 = new bi_forest.geral_fato_0_1.GERAL_FATO();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CARGA_GERAL.class.getClassLoader().getResourceAsStream("bi_forest/carga_geral_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CARGA_GERAL.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CARGA_GERAL");
        }
...
/************************************************************************************************
 *     49402 characters generated by Talend Open Studio for Data Integration 
