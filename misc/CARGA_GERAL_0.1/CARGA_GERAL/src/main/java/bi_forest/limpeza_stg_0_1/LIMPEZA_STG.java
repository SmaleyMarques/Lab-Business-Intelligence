...
package bi_forest.limpeza_stg_0_1;
...
/**
 * Job: LIMPEZA_STG Purpose: <br>
 * Description: TRUNCATE TABELAS STAGE <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class LIMPEZA_STG implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "LIMPEZA_STG";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LIMPEZA_STG.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:EB7uXoe2PCRYi9yXuqDuKO+1Aix92GVzSe6haiXv1lKDcPzL");
 ...
 */
    ...
    public static void main(String[] args){
        final LIMPEZA_STG LIMPEZA_STGClass = new LIMPEZA_STG();

        int exitCode = LIMPEZA_STGClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LIMPEZA_STG.class.getClassLoader().getResourceAsStream("bi_forest/limpeza_stg_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LIMPEZA_STG.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LIMPEZA_STG");
        }
...
/************************************************************************************************
 *     28791 characters generated by Talend Open Studio for Data Integration 
 *     on the 19 de Maio de 2024 22h3min58s BRT
 ************************************************************************************************/