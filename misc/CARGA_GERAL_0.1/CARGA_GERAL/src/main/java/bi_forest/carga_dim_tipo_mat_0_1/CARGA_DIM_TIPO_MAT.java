...
package bi_forest.carga_dim_tipo_mat_0_1;
...
/**
 * Job: CARGA_DIM_TIPO_MAT Purpose: <br>
 * Description: CADASTRO TIPO MATERIAL <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class CARGA_DIM_TIPO_MAT implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "CARGA_DIM_TIPO_MAT";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				CARGA_DIM_TIPO_MAT.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CARGA_DIM_TIPO_MAT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_BI_FOREST_CARGA_DIM_TIPO_MAT = new byte[0];
    static byte[] commonByteArray_BI_FOREST_CARGA_DIM_TIPO_MAT = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BI_FOREST_CARGA_DIM_TIPO_MAT.length) {
				if(length < 1024 && commonByteArray_BI_FOREST_CARGA_DIM_TIPO_MAT.length == 0) {
   					commonByteArray_BI_FOREST_CARGA_DIM_TIPO_MAT = new byte[1024];
				} else {
   					commonByteArray_BI_FOREST_CARGA_DIM_TIPO_MAT = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BI_FOREST_CARGA_DIM_TIPO_MAT, 0, length);
			strReturn = new String(commonByteArray_BI_FOREST_CARGA_DIM_TIPO_MAT, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BI_FOREST_CARGA_DIM_TIPO_MAT) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DESC_TIP_MAT = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.DESC_TIP_MAT,dos);
    ...
    public int compareTo(row1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.SK_TIP_MAT, other.SK_TIP_MAT);
						if(returnValue != 0) {
							return returnValue;
						}
	...
	class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				int result = DEFAULT_HASHCODE;
							...
							result = prime * result + ((this.DESC_TIP_MAT == null) ? 0 : this.DESC_TIP_MAT.hashCode());
		...
		public boolean equals(Object obj) {
			...
			final AggOperationStruct_tAggregateRow_1 other = (AggOperationStruct_tAggregateRow_1) obj;
							...
							if (this.DESC_TIP_MAT == null) {
								if (other.DESC_TIP_MAT != null) 
									return false;
							} else if (!this.DESC_TIP_MAT.equals(other.DESC_TIP_MAT)) 
								return false;
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:IdCsJluiOu66hMXocdGT7U/QstclO499J74uJg3Hv3QQPfe+");
		    ...
		    String dbquery_tDBInput_1 = "SELECT dbo.STG_TIPO_MAT.COD_EMPRESA,\n		dbo.STG_TIPO_MAT.COD_TIP_MAT,\n		dbo.STG_TIPO_MAT.DESC_TIP_MAT\nFROM	dbo.STG_TIPO_"
+"MAT";
            ...
            row2.COD_TIP_MAT = rs_tDBInput_1.getInt(2);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row2.DESC_TIP_MAT = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.DESC_TIP_MAT = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row2.DESC_TIP_MAT = tmpContent_tDBInput_1;
                }
            } else {
                row2.DESC_TIP_MAT = null;
            }
...
// # Output table : 'SAIDA'
SAIDA_tmp.SK_TIP_MAT = 0;
SAIDA_tmp.SK_EMPRESA = row3.SK_EMPRESA ;
SAIDA_tmp.COD_TIP_MAT = row2.COD_TIP_MAT ;
SAIDA_tmp.DESC_TIP_MAT = row2.DESC_TIP_MAT ;
SAIDA = SAIDA_tmp;
...
operation_finder_tAggregateRow_1.SK_TIP_MAT = SAIDA.SK_TIP_MAT;
			...
			operation_finder_tAggregateRow_1.COD_TIP_MAT = SAIDA.COD_TIP_MAT;
			operation_finder_tAggregateRow_1.DESC_TIP_MAT = SAIDA.DESC_TIP_MAT;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_1.SK_TIP_MAT = operation_finder_tAggregateRow_1.SK_TIP_MAT;
				...
				operation_result_tAggregateRow_1.COD_TIP_MAT = operation_finder_tAggregateRow_1.COD_TIP_MAT;
				operation_result_tAggregateRow_1.DESC_TIP_MAT = operation_finder_tAggregateRow_1.DESC_TIP_MAT;
...
public int hashCode() {
if(hashCodeDirty) {
int prime = 31;hashCode = prime * hashCode + COD_TIP_MAT;
...
String dbUser_tDBSCD_1 = null;
	...
	final String decryptedPassword_tDBSCD_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:CDLEUAQFxO8F++oVJfjQ0rRDcmXWQKq7tDhgzJynglhCxwaM");
    ...
    if(dbschema_tDBSCD_1 == null || dbschema_tDBSCD_1.trim().length() == 0) {
        tableName_tDBSCD_1 = "DIM_TIPO_MAT";
    } else {
        tableName_tDBSCD_1 = dbschema_tDBSCD_1 + "].[" + "DIM_TIPO_MAT";
    }
    ...
    String tmpValue_tDBSCD_1 = null;    
        String search_tDBSCD_1 = "SELECT [COD_TIP_MAT], [SK_EMPRESA], [DESC_TIP_MAT] FROM [" + tableName_tDBSCD_1 + "]";
        ...
        while(resultSet_tDBSCD_1.next()) {
            ...
            SCDStruct_tDBSCD_1 row_tDBSCD_1 = new SCDStruct_tDBSCD_1();
                    if(resultSet_tDBSCD_1.getObject(1) != null) {
                        sk_tDBSCD_1.COD_TIP_MAT = resultSet_tDBSCD_1.getInt(1);
                    }
                    ...
                    if(resultSet_tDBSCD_1.getObject(3) != null) {
                        row_tDBSCD_1.DESC_TIP_MAT = resultSet_tDBSCD_1.getString(3);
                    }
        ...
        String tmpQuery_tDBSCD_1 = "SELECT MAX([SK_TIP_MAT]) FROM [" + tableName_tDBSCD_1 + "]";
    ...
    String insertionSQL_tDBSCD_1 = "INSERT INTO [" + tableName_tDBSCD_1 + "]([SK_TIP_MAT], [COD_TIP_MAT], [SK_EMPRESA], [DESC_TIP_MAT]) VALUES(?, ?, ?, ?)";
    java.sql.PreparedStatement insertionStatement_tDBSCD_1 = conn_tDBSCD_1.prepareStatement(insertionSQL_tDBSCD_1);
        String updateSQLForType1_tDBSCD_1 = "UPDATE [" + tableName_tDBSCD_1 + "] SET [DESC_TIP_MAT] = ? WHERE [COD_TIP_MAT] = ? AND [SK_EMPRESA] = ?";
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row1.SK_TIP_MAT = aggregated_row_tAggregateRow_1.SK_TIP_MAT;
            				    
            				    row1.SK_EMPRESA = aggregated_row_tAggregateRow_1.SK_EMPRESA;
            				    
            				    row1.COD_TIP_MAT = aggregated_row_tAggregateRow_1.COD_TIP_MAT;
            				    
            				    row1.DESC_TIP_MAT = aggregated_row_tAggregateRow_1.DESC_TIP_MAT;
 ...
 */
	...
	try {
        lookUpKey_tDBSCD_1 = new SCDSK_tDBSCD_1();
            lookUpKey_tDBSCD_1.COD_TIP_MAT = row1.COD_TIP_MAT;
    ...
    if(lookUpValue_tDBSCD_1 == null) {
            lookUpValue_tDBSCD_1 = new SCDStruct_tDBSCD_1();
                    ...
                    insertionStatement_tDBSCD_1.setInt(2, row1.COD_TIP_MAT);

                    insertionStatement_tDBSCD_1.setInt(3, row1.SK_EMPRESA);

                    if(row1.DESC_TIP_MAT == null) {
insertionStatement_tDBSCD_1.setNull(4, java.sql.Types.VARCHAR);
} else {
insertionStatement_tDBSCD_1.setString(4, row1.DESC_TIP_MAT);
}

        nb_line_inserted_tDBSCD_1 += insertionStatement_tDBSCD_1.executeUpdate();
    } else {
            if((lookUpValue_tDBSCD_1.DESC_TIP_MAT == null && row1.DESC_TIP_MAT!= null) || (lookUpValue_tDBSCD_1.DESC_TIP_MAT != null && !lookUpValue_tDBSCD_1.DESC_TIP_MAT.equals(row1.DESC_TIP_MAT))) {
                    if(row1.DESC_TIP_MAT == null) {
updateForType1_tDBSCD_1.setNull(1, java.sql.Types.VARCHAR);
} else {
updateForType1_tDBSCD_1.setString(1, row1.DESC_TIP_MAT);
}

                    updateForType1_tDBSCD_1.setInt(2, row1.COD_TIP_MAT);
                ...
                lookUpValue_tDBSCD_1.DESC_TIP_MAT = row1.DESC_TIP_MAT;
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:xVZn99mDf9rb2rcJIg6/g6mmhnPpK1Qrv5U0yrDu4+Uvsxo5");
 ...
 */
    ...
    public static void main(String[] args){
        final CARGA_DIM_TIPO_MAT CARGA_DIM_TIPO_MATClass = new CARGA_DIM_TIPO_MAT();

        int exitCode = CARGA_DIM_TIPO_MATClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CARGA_DIM_TIPO_MAT.class.getClassLoader().getResourceAsStream("bi_forest/carga_dim_tipo_mat_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CARGA_DIM_TIPO_MAT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CARGA_DIM_TIPO_MAT");
        }
...
/************************************************************************************************
 *     100298 characters generated by Talend Open Studio for Data Integration 
